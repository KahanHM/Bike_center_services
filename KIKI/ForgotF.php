...
<body>
    <form action="ForgotB.php" method="post">
	<div class="row">
		<h1>Forgot Password</h1>
		<h6 class="information-text">Enter your registered email to reset your password.</h6>
		<div class="form-group">
			<input type="text" name="email" placeholder="Email" />
			<input type="submit" name="Reset" value="Reset Password" onclick="showSpinner()"/><a href="ForgotB.php"></a>
		</div>
		<div class="footer">
			<h5>New here? <a href="signupF.php">Sign Up.</a></h5>
			<h5>Already have an account? <a href="UloginF.php">Sign In.</a></h5>
