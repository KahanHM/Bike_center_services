...
<div id="feedback-main">
  <div id="feedback-div">
    <form action="feedbackB.php" method="post" class="form" id="feedback-form1" name="form1" enctype="multipart/form-data">
      ...
      <p class="text">
        <textarea name="feedback" type="text" class="validate[required,custom[feedback]] feedback-input" id="feedback" placeholder="Feedback" required ></textarea>
      </p>
